...
pub const THREAD_NOT_FOUND_ERROR_CODE: i64 = -32004;
...
pub(crate) fn thread_not_found(message: impl Into<String>) -> JSONRPCErrorError {
    error(THREAD_NOT_FOUND_ERROR_CODE, message)
}
